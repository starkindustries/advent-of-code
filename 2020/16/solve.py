...
assert not valid_rule_for_column(rule, 0, tickets, 0)
assert valid_rule_for_column(rule, 0, tickets, 1)
assert valid_rule_for_column(rule, 0, tickets, 2)

rule = [[[0, 5], [8, 19]]]
assert valid_rule_for_column(rule, 0, tickets, 0)
assert valid_rule_for_column(rule, 0, tickets, 1)
assert valid_rule_for_column(rule, 0, tickets, 2)
assert not valid_rule_for_column(rule, 0, [[6]], 0)
assert not valid_rule_for_column(rule, 0, [[7]], 0)
assert not valid_rule_for_column(rule, 0, [[20]], 0)
