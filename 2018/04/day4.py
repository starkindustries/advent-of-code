...
def printGuardTracker(guardTrackerCopy):
    print(
        "DATE ID          000000000011111111112222222222333333333344444444445555555555"
    )
    print(
...
print(
    "Part 2: #{} {}minutes, minute {}, answer: {}".format(
        guardNum, maxSleepyTimeFinal, mostSleepyMinuteFinal, answer
    )
)
